...
taxa = pd.read_csv('normalized_edge.csv', index_col=0)
...
taxa.to_csv('taxa_abundance_normalized_percent.csv')

print("The output is in taxa_abundance_normalized_percent.csv")
