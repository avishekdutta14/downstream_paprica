...
#for finding enzymes related to sulfur cycle

sulfur_enzymes = ['1.8.1.2', '1.8.7.1', '1.8.99.1', '1.97.1.3', '1.13.11.18', '1.13.11.5', '2.8.1.5', '1.8.2.2', '1.8.5.2' , '2.8.1.1', '3.12.1.1', '1.8.99.3', '1.8.2.1', '1.8.3.1', '1.12.98.4', '4.4.1.6', '3.5.5.8', '4.4.1.1', '4.4.1.8', '1.8.1.6', '4.4.1.15', '4.4.1.9', '4.4.1.10', '4.2.1.1', '2.8.1.3', '4.4.1.2', '1.13.11.20', '3.1.6.1', '1.8.3.4']

ID = pe["ID"]

sulfur_common = set(ID) & set(sulfur_enzymes)

sulfur = pe.loc[pe['ID'].isin(sulfur_common)]

sulfur.to_csv('sulfur_cycle.csv', header=True)

#for finding enzymes related to nitrogen cycle

nitrogen_enzymes = ['1.7.99.4', '1.9.6.1', '1.7.2.1', '1.7.99.7', '1.7.99.6', '1.7.2.2', '1.7.3.4', '1.7.99.4', '1.7.99.1', '1.7.99.8', '3.6.3.21', '3.6.3.22', '3.6.3.23', '3.6.3.26', '3.6.3.31', '3.6.3.32', '3.6.3.36', '3.6.3.37', '3.6.3.43', '1.7.1.1', '1.7.1.2', '1.7.1.3', '1.7.7.2', '1.7.7.1', '1.7.1.4', '1.4.1.2', '1.4.1.3', '1.4.1.4', '1.4.1.13', '1.4.1.14', '1.4.7.1', '6.3.1.1', '1.18.6.1', '1.19.6.1', '3.5.1.5', '6.3.4.6', '3.5.1.54']

nitrogen_common = set(ID) & set(nitrogen_enzymes)

nitrogen = pe.loc[pe['ID'].isin(nitrogen_common)]
